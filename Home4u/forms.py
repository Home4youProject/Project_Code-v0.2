...
class PaymentCreditForm(FlaskForm):
    card_name = StringField('Όνομα στη κάρτα', validators=[InputRequired()])
    card_number = IntegerField('Αριθμός της κάρτας', validators=[InputRequired()])
    cvv = IntegerField('CVV', validators=[InputRequired(), NumberRange(min=100, max=999, message='3 ψήφιο πεδίο')])
